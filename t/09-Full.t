...
use_ok('Finance::Accounting::Bookkeeping::Ledger::AccountFactory');
use Finance::Accounting::Bookkeeping::Ledger::Account::Asset;
...
my $af = Finance::Accounting::Bookkeeping::Ledger::AccountFactory->new;
my $asset = $af->create('Asset')->new(account_name => 101);
